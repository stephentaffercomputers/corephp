...
function list_prop_types(){
	$sql_list_prop_types = "select distinct PropertyType, PropertySubType from medical_listing order by PropertyType, PropertySubType;";
...
<br>
Customer has had and shall have the opportunity to submit to Featured Property descriptions, photographs, images, contact or other information (collectively, the "Submitted Content") for each featured listing on our site. You represent and warrant that (a) you own or have the full right, power and authority to grant to MedicalOfficeSpace.us use of and rights in and to all Submitted Content that you upload, post, e-mail or otherwise transmit to MedicalOfficeSpace.us; (b) your license of such content to MedicalOfficeSpace.us hereunder does not, and the use or license of such content by MedicalOfficeSpace.us to third parties will not, infringe any right or interest owned or possessed by any third party; and (c) there are no claims, judgments or settlements to be paid by you, or pending claims or litigation, relating to such content.
<br /><br />
With respect to all Submitted Content you have uploaded in the past or elect to upload in the future, post, e-mail or otherwise transmit to or via the Service, MedicalOfficeSpace.us acknowledges that you retain any applicable ownership rights that you may have with respect to the Submitted Content. You nonetheless grant MedicalOfficeSpace.us and its affiliates (including without limitation other MedicalOfficeSpace.us companies) and their licensees a royalty-free, worldwide, perpetual, irrevocable, non-exclusive and fully sub-licensable right and license (through multiple tiers) to use, reproduce, adapt, perform, display, publish, translate, prepare derivative works from, modify, distribute, sell, and take any other action with respect to all such Submitted Content (in whole or part), whether submitted in the past or in the future, and/or to incorporate it in other works in any form, media, or technology now known or later developed. You further acknowledge and agree that MedicalOfficeSpace.us may preserve any such Submitted Content, whether submitted in the past or in the future, and may also disclose such Submitted Content in its sole discretion (including without limitation within other products offered by MedicalOfficeSpace.us and its affiliates, including other MedicalOfficeSpace.us companies).
<br /><br />
Customer agrees not to submit any Submitted Content to MedicalOfficeSpace.us unless the Customer has received all necessary rights and authorizations, including from the photographer or videographer and/or copyright owner of any photographs or videos, to publish and advertise the property listing on the Customer's website or on MedicalOfficeSpace.us's website. Specifically, Customer will not submit a photograph if Customer received the photograph from a third party information provider under the terms of a license that does not allow posting of such photograph. The Company may, in its sole discretion but without any obligation to search for such, remove property listings that are alleged to have been submitted in violation of this provision. In addition, the Company may require additional evidence of compliance with this provision from Customers who are alleged to have submitted property listings, Submitted Content or other information in violation of this Agreement. The Company will, in its sole discretion, remove content and refuse service to, any Customer who repeatedly or knowingly violates this Agreement. Customer agrees to maintain accurate contact information (specifically, a valid phone number and email address) in order to submit and maintain active property listings on the MedicalOfficeSpace.us website. Customer shall not use robot, spider or other automated service to submit listings on the MedicalOfficeSpace.us website. Additionally, the Customer agrees to allow submitted property listing(s) and Submitted Content, or any part therein, to be searched, displayed, accessed, downloaded, copied, and otherwise referred to by users of the Customer's website, the MedicalOfficeSpace.us website and other MedicalOfficeSpace.us partner or affiliate websites, including without limitation other MedicalOfficeSpace.us company websites. The Company shall have the sole authority to choose the manner in which any property listing will be searched, displayed, accessed, downloaded, copied, and otherwise used on the MedicalOfficeSpace.us website and Company shall have the right to modify the property listing in the exercise of its rights under this Agreement. The Customer (a) represents and warrants that all properties and associated information provided by the Customer, including Submitted Content, will be accurate; (b) agrees not to post a property listing on the public MedicalOfficeSpace.us under a name other than the individually named licensed real estate agents that have been engaged by the property owner to market the property under the terms of a duly executed listing agreement with the owner (shared accounts, e.g. listings@abcrealty.com are prohibited); (c) agrees to administer the properties provided by the Customer and maintain their accuracy at all times. The Company reserves, in a manner consistent with reasonable commercial business practices, the right to remove all or any part of the property listings posted on the Customer's website or on the MedicalOfficeSpace.us website. The Customer is entirely responsible, and Company accepts no responsibility, for the Submitted Content from the Customer. While the Company shall take all reasonable efforts for data backup and business resumption, the Customer will be solely responsible for retaining back-up copies of all information, photographs and other materials it provides to MedicalOfficeSpace.us. MedicalOfficeSpace.us may add digital watermarks to certain parts of your property listing, including photographs. We add these digital watermarks to protect against the copying or further distribution of your photographs without your permission. Customer agrees that MedicalOfficeSpace.us may adjust portions of the information contained within the Service (e.g., within property listings). Any such adjustments will have no material impact on the meaning and interpretation of property listings, but will serve as a means of uniquely identifying the property listings as having been supplied to the Customer. Customer accepts that this is a legitimate and lawful security precaution on the part of MedicalOfficeSpace.us, and accepts further that in the event that any third party has access to property listings that can be identified as having Customer's unique adjustments a prima facie breach of security and of these Terms of Use on the part of Customer may be assumed by MedicalOfficeSpace.us.<br /><br /> 
