<?php include 'header.php'; ?>
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1><a href="/">Home</a> / <a href="/warehouse-for-rent/United-States/<?=$row['StateProvCode']?>"><?=$row['StateProvCode']?></a> / <a href="/warehouse-for-rent/United-States/<?=$row['StateProvCode']?>/<?=$row['CityName']?>"><?=$row['CityName']?> Warehouses for Rent</a></h1>
					</div>
				</div>
			</div>
		</div>
