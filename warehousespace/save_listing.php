...
if ($_POST['is_submit'] && $_POST['listing_have_right'])
{
	...
	if ($_FILES['listing_image'] && $_FILES['listing_image']['error'] == UPLOAD_ERR_OK) {
		...
		if (($img_info = getimagesize($img)) !== FALSE) {
			...
			$sql .= "PhotoURL = 'http://www.warehousespaces.com/".$dst."' ";
	...
	mail("johngalaxidas@synreg.com", "WarehouseSpaces.com - New Listing Submission", "A new listing was submitted in the WarehouseSpaces.com database.<br /><br />Please go to <a href='http://www.warehousespaces.com/listing_preview.php?id=".$last_insert_id."'>http://www.warehousespaces.com/listing_preview.php?id=".$last_insert_id."</a> and approve or delete the listing.", 'MIME-Version: 1.0' . "\r\n" . 'Content-type: text/html; charset=iso-8859-1' . "\r\n");
}
?>
