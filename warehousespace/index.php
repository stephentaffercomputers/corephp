<?php include 'header.php'; ?>
        <div class="section section-white">
	    	<div class="container" style="background: url('https://warehousespaces.com/images/bg-image4.jpg') no-repeat scroll center center transparent;">
				<div class="row-fluid" style="min-height: 400px;">
					<div class="col-md-8">
					<div id="heading" style="background: none repeat scroll 0% 0% rgba(0, 0, 0, 0.65); color: #FFF; margin: 100px 0 50px 30px; padding: 5px; text-align: center;"><h1 style="color: inherit;">Find Warehouses for Rent and/or Sale</h1>					</div>
