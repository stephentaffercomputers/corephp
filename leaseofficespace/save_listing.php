...
if ($_POST['is_submit'] && $_POST['listing_have_right'])
{
	...
	if ($_FILES['listing_image'] && $_FILES['listing_image']['error'] == UPLOAD_ERR_OK) {
		...
		if (($img_info = getimagesize($img)) !== FALSE) {
			...
			$sql .= "PhotoURL = 'https://leaseofficespace.net/".$dst."' ";
	...
	mail("johngalaxidas@synreg.com", "LeaseOfficeSpace.net - New Listing Submission", "A new listing was submitted in the LeaseOfficeSpace.net database.<br /><br />Please go to <a href='https://leaseofficespace.net/listing_preview.php?id=".$last_insert_id."'>https://leaseofficespace.net/listing_preview.php?id=".$last_insert_id."</a> and approve or delete the listing.", 'MIME-Version: 1.0' . "\r\n" . 'Content-type: text/html; charset=iso-8859-1' . "\r\n");
}
?>
