...
$vicinity_sql_stmt  = "SELECT * FROM office_listing WHERE ListingIsActive = 'y' AND
...
while ($vicinity_row = mysqli_fetch_array($vicinity_result)) 
{
	...
	$sidebar_content .='<table class="results-table"><tbody class="results-tbody"><tr><td rowspan="2" class="span3"><a href="/offices-for-rent/'.$vicinity_row["StateProvCode"].'/'.$vicinity_row['CityName'].'/'.$vicinity_row['ListingID'].'"> <img class="img-polaroid" id="img'.$vicinity_row['ListingID'].'" width="150" alt="'.$vicinity_row['StreetAddress'].'" src=\'';
