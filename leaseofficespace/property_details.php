		...
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-9">
						<h1><a href="/">Home</a> / <a href="/offices-for-rent/<?=$row['StateProvCode']?>"><?=$row['StateProvCode']?></a> / <a href="/offices-for-rent/<?=$row['StateProvCode']?>/<?=$row['CityName']?>"><?=$row['CityName']?> Offices for Rent</a></h1>
					</div>
...
<i><h5>It's fast, simple and Free!</h5></i>
				...
				<!-- <label for="property_type">Type:</label> !-->	
                    ...
                    <input type="hidden" placeholder="Square Feet?" name="contact_sq_ft" value="<?=number_format ($row['SpaceAvailableTotal'] != "")?number_format (ereg_replace("[^-0-9\.]","",$row['SpaceAvailableTotal'])):number_format (ereg_replace("[^-0-9\.]","",$row['SpaceAvailableMin']))?> sq. ft.">
