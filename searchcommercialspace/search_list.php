...
$sql_list_cities = "SELECT distinct concat(CityName, ', ',trim(PostalCode)) as search_result  FROM listings WHERE concat( CityName,StateProvCode, PostalCode) like '".$q."%' ORDER BY CityName LIMIT ".$limit.";"; //StateProvName
