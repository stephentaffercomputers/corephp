...
//$string = file_get_contents('D:/ColdFusion10/cfusion/wwwroot/InsurancePlans/syn_report.html');
	//$string = file_get_contents('D:/downloads/document.json');
//	 $string = file_get_contents('D:/workspace/largewarehouse/ws/san_diego_over_10k_053113.txt');
...
//		echo($sql_stmt_values."<br>");
	...
	switch (json_last_error()) {
        case JSON_ERROR_NONE:
            echo ' - No errors';
			$qry_stmt = "insert into listings (CountryCode, StateProvName, StateProvCode, CityName, PostalCode, StreetAddress, Latitude, Longitude, PhotoID, PhotoExt, PropertyType, PropertySubtype, Zoning, BuildingSize, LotSize, YearBuilt, PropertyDescription, LocationDescription, RentalRateMin,RentalRateMax, SpaceAvailableMin, SpaceAvailableMax, SpaceCount, Apn, PhotoURL, BrokerName, BrokerEmail, BrokerCompany, BrokerPhone, BrokerLicNumber, BrokerLogo, BrokerLogoExt, suiteno, availdate, SpaceAvailableTotal) values".substr($sql_stmt_values, 0,-1);
