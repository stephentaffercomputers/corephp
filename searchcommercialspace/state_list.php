...
$sql_list_cities = 'select distinct StateProvCode from listings where ListingIsActive = \'y\' AND trim(StateProvCode) <> "" order by StateProvCode;';
...
while ($row = mysqli_fetch_array($result)) 
{
	...
	print "<li><a href=\"/warehouse-for-rent/United-States/".$row['StateProvCode']."\">".$states[$row['StateProvCode']]."</a><br />Cities Covered: ";
	
	$sql = 'select distinct cityname from listings where ListingIsActive = \'y\' AND StateProvCode = "'.$row['StateProvCode'].'"';
