...
if (sizeof($q) > 1 )
$search_sql_stmt = "select * from listings where CityName ='".trim($q[0])."' and PostalCode = '".trim($q[1])."';";
else
$q= $search_sql_stmt = "select * from listings WHERE concat( CityName,StateProvCode, StateProvName, PostalCode) like '%".$q[0]."%' ORDER BY CityName"; // ."LIMIT ".$limit.";";
