	    ...
	    <div class="footer">
	    	<div class="container">
		    	<div class="row">
		    		<div class="col-md-12">
		    			<div class="footer-copyright"><a href="https://leaseretailspace.net/terms.php">Terms & Conditions</a> | <a href="https://leaseretailspace.net/privacy.php">Privacy Policy</a> | <a href="https://leaseretailspace.net/disclaimer.php">Listings Disclaimer</a> | <a href="https://leaseretailspace.net/add_listing.php">Submit Listing</a><br />&copy; <? echo date("Y"); ?> LeaseRetailSpace.net - All rights reserved.</div>
		    		</div>
		    	</div>
		    </div>
	    </div>
