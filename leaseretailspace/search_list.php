...
$sql_list_cities = "SELECT distinct concat(CityName, ', ',trim(PostalCode)) as search_result  FROM retail_listing WHERE concat( CityName,StateProvCode, PostalCode) like '".$q."%' ORDER BY CityName LIMIT ".$limit.";"; //StateProvName
