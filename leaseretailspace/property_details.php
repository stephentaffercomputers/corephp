		...
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-9">
						<h1><a href="/">Home</a> / <a href="/retail-for-rent/United-States/<?=$row['StateProvCode']?>"><?=$row['StateProvCode']?></a> / <a href="/retail-for-rent/United-States/<?=$row['StateProvCode']?>/<?=$row['CityName']?>"><?=$row['CityName']?> Retail Spaces for Rent</a></h1>
					</div>
...
if($rental_rate_min == '0.00/SF/Month') {
    $rental_rate_min = number_format(substr($rent_amount,0,4),2) . '/SF/Month';
}
?>
