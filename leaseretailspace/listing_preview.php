<?php include 'header.php'; ?>
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1><a href="/">Home</a> / <a href="/retail-for-rent/<?=$row['StateProvCode']?>"><?=$row['StateProvCode']?></a> / <a href="/retail-for-rent/<?=$row['StateProvCode']?>/<?=$row['CityName']?>"><?=$row['CityName']?> Retail for Rent</a></h1>
					</div>
				</div>
			</div>
		</div>
...
else $thisRate = '$ '.number_format($row['MonthlyRate']).'/mo';
...
<ul class="unstyled">
<li> <i class="icon-ok"></i> <em> Free report on your selected retail </em></li>
